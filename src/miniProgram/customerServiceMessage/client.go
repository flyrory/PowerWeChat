...
import (
	...
	"github.com/flyrory/PowerWeChat/v3/src/miniProgram/customerServiceMessage/request"
	"github.com/flyrory/PowerWeChat/v3/src/miniProgram/customerServiceMessage/response"
	response4 "github.com/flyrory/PowerWeChat/v3/src/work/media/response"
	"net/http"
)
