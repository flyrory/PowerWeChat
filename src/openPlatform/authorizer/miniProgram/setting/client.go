...
import (
	...
	"github.com/flyrory/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/setting/request"
	"github.com/flyrory/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/setting/response"
)
