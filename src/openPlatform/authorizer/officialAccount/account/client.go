...
import (
	...
	"github.com/flyrory/PowerWeChat/v3/src/openPlatform/authorizer/aggregate/account"
	"github.com/flyrory/PowerWeChat/v3/src/openPlatform/authorizer/officialAccount/account/response"
)
