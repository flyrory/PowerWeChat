...
import (
	...
	"github.com/flyrory/PowerWeChat/v3/src/officialAccount/customerService/request"
	"github.com/flyrory/PowerWeChat/v3/src/officialAccount/customerService/response"
)
