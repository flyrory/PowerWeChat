...
import (
	...
	"github.com/flyrory/PowerWeChat/v3/src/officialAccount/templateMessage/request"
	"github.com/flyrory/PowerWeChat/v3/src/officialAccount/templateMessage/response"
)
